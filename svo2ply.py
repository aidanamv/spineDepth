...
def main():
    ...
    filepath = "J:/Aidana_data/Specimen_9/Recordings/Recording20/Video_0.svo"
   ...
   # nb_frames = 5
    ...
    while True:  # change to True
        ...
        if zed.grab(runtime_parameters) == sl.ERROR_CODE.SUCCESS:
            ...
            image.write(os.path.join(output_dir, 'left_image1.png'))
            image_r.write(os.path.join(output_dir, 'right_image1.png'))
